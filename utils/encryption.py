...
ctx = execjs.compile(open("utils/sandbox.js", "r").read())
def create_wb_result(user_agent: str, encryption_key: str, challenge_website: str) -> str:
    fingerprint = {
    "0":[
        "length",
        "innerWidth",
    ...
    "x":[
        ...
        "d.onscrollend",
        "d.onscrollsnapchange",
        "d.onscrollsnapchanging",
        "d.ownerDocument",
        "d.parentNode",
        "d.parentElement",
        "d.previousSibling",
    ...
    "www." + challenge_website.split('https://')[1]:[
        "d.domain"
    ],
    "s":[
        "d.cookie"
    ...
    result = ctx.call("encode", fingerprint, encryption_key)
    return result
